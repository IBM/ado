...
- Ensuring AI Code Quality: We maintain coding rules for AI agents within the
  repository in standard format (Agents.md, SKILLS). Furthermore, ado's pydantic
  base provides self-describing schemas and built-in validation for many
  components. This creates a tight feedback loop (e.g., generate, validate,
