...
[**memoization**](../../concepts/data-sharing.md#memoization): if it samples
...
- Transparent and distributed
  [memoization](../../concepts/data-sharing.md#memoization)
...
- `metric_format` (default "target")
    ...
    - **"target"**: Use [target property identifiers](../../concepts/actuators.md#target-and-observed-properties)
      (e.g., `"latency"`)
...
"[constitutive property id](../../concepts/entity-spaces.md#entities)/"value"
pairs.
