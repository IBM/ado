...
- An **experiment**: An [actuator](../core-concepts/actuators.md) or a
  [custom experiment](../actuators/creating-custom-experiments.md) that measures
  or evaluates a system (e.g., a benchmark, a simulation).
- An **analysis tool**: An [operator](../operators/working-with-operators.md)
