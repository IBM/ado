...
class TestDetermineThreadpoolUsage:
    ...
    def test_with_negative_workers(self) -> None:
        ...
        with pytest.raises(ValueError, match="must be non-negative"):
            _determine_threadpool_usage(values)
