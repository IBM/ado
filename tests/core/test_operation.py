...
def test_script_operator_conf_round_trip() -> None:
    ...
    script_module = ScriptOperatorConf(name="grid-sweep", version="1.0.0")
    assert script_module.operationType == DiscoveryOperationEnum.SCRIPT
...
def test_script_operation_resource_identifier() -> None:
    ...
    script_module = ScriptOperatorConf(name="inline-script")
    operation_configuration = DiscoveryOperationResourceConfiguration(
    ...
    assert operation.operationType == DiscoveryOperationEnum.SCRIPT
