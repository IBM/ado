...
"""Legacy migrator for adding UTC timezone to naive operation created timestamps"""
...
@legacy_migrator(
    identifier="operation_created_timezone_utc",
    ...
    description="Adds UTC timezone information to naive operation created timestamps.",
)
