...
"""Legacy migrator for adding UTC timezone to naive sample store created timestamps"""
...
@legacy_migrator(
    identifier="samplestore_created_timezone_utc",
    ...
    description="Adds UTC timezone information to naive sample store created timestamps.",
)
