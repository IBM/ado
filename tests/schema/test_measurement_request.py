...
def test_string_representation(
    ...
    assert str(
        request
    ) == "request-{}-experiment-{}-entities-{}-requester-{}-time-{}".format(
        request.requestid,
    ...
    assert str(
        request
    ) == "request-{}-experiment-{}-entities-multi-{}-requester-{}-time-{}".format(
        request.requestid,
        request.experimentReference.experimentIdentifier,
        2,
        request.operation_id,
...
def test_string_representation_replayed(
    ...
    assert str(request) == "{}-experiment-{}-entities-{}-time-{}".format(
        request.requestid,
        request.experimentReference.experimentIdentifier,
        entity,
        request.timestamp,
    ...
    assert str(request) == "{}-experiment-{}-entities-multi-{}-time-{}".format(
        request.requestid,
        request.experimentReference.experimentIdentifier,
        2,
        request.timestamp,
