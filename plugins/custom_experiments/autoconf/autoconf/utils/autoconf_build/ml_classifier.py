...
cols_to_use = [
    ...
    # NOTE: jobs that are not successful for incorrect specification of the config file must have been filtered out before.
    ...
    # The only exception to this rule are the rules explicit in the imported function filter_valid_with_hard_logic
]

# %% Print models

print(set(df_original["model_name"].values))
...
model_path = (
    predictor.path
)  # "/Users/danielelotito/Documents/github/genai-planning/autoconf_build/autoconf_build/AutogluonModels"
