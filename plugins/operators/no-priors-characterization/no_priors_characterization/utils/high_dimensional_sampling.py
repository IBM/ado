...
if __name__ == "__main__":
    ...
    except ModuleNotFoundError:  # matplot lib is not a required dependency
        print("matplotlib not found. Please install it to run the demo.")
        exit()
    ...
    # --- Configuration ---
    dimensions = [20, 6]  # 4 columns, 6 rows (Total 24 cells)
