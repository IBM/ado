...
def valid_ado_mysql_project_context(
...
) -> Generator[orchestrator.metastore.project.ProjectContext, None, None]:
    ...
    """
    from orchestrator.metastore.sql.utils import _engine_cache

    context = orchestrator.metastore.project.ProjectContext.model_validate(
