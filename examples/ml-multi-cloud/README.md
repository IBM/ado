...
- `ml_multicloud_sample_store.yaml` — samplestore definition (loads `ml_export.csv`)
- `ml_multicloud_space.yaml` — discoveryspace for the random walk example
- `ml_multicloud_space_with_custom.yaml` — discoveryspace with custom cost experiment
- `randomwalk_ml_multicloud_operation.yaml` — random walk operation
- `lhc_sampler.yaml` — Latin Hypercube sampler operation
